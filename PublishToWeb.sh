...
pandoc -o web/vendor_instructions.html -f markdown+fancy_lists -s '.\vendor_instructions.md' --css  "css/pandoc.css" -H '.\header.html' --metadata date="`date +%F`"
...
java -jar ~/OneDrive\ -\ cchmc/Programs/daisydiff-1.2/daisydiff.jar web/old.html web/index.html --file=web/diff.html --css=web/css/pandoc.css
